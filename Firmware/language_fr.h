...
#define(length=19, lines=1) MSG_USED						"Utilise durant impr" //Do not change length
...
#define(length=12, lines=1)	MSG_LEFT						"Gauche:" //Do not change length
#define(length=12, lines=1) MSG_CENTER						"Centre:" //Do not change length
#define(length=12, lines=1) MSG_RIGHT						"Droit:" //Do not change length
#define(length=15, lines=1) MSG_MEASURED_SKEW				"Mesure angle:" //Do not change length
#define(length=15, lines=1) MSG_SLIGHT_SKEW					"Leger angle:" //Do not change length
#define(length=15, lines=1) MSG_SEVERE_SKEW					"Fort angle:" //Do not change length
#define(length=20, lines=4) MSG_DEFAULT_SETTINGS_LOADED		"Default settings loaded"
#define(length=17, lines=1) MSG_SORT_TIME					"Tri: [Date]" //Do not change length
#define(length=17, lines=1) MSG_SORT_ALPHA					"Tri: [Alphabet]" //Do not change length
#define(length=17, lines=1) MSG_SORT_NONE					"Tri: [Aucun]" //Do not change length
#define(length=20, lines=1) MSG_SORTING						"Tri fichiers" //Do not change length
#define(length=20, lines=2) MSG_FILE_INCOMPLETE				"Fichier incomplet, continuer?" //Do not change length
#define(length=17, lines=1) MSG_WIZARD						"Assistant" //Do not change length
...
#define(length=20, lines=2) MSG_WIZARD_FILAMENT_LOADED		"Filament charge?" //Do not change length
...
#define(length=20, lines=2) MSG_WIZARD_PLA_FILAMENT			"PLA filament en place?" //Do not change length
...
#define(length=20, lines=2) MSG_PLA_FILAMENT_LOADED			"Filament PLA charge?" //Do not change length
